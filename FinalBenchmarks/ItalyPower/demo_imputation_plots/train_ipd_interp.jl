...
# stats, p1_ns = any_impute_single_timeseries(fc, 0, 2, interp_sites, :directMedian; invert_transform=true, 
...
# plot(p1_ns...)
stats, p2_ns = any_impute_median(fc, 0, 2, interp_sites; NN_baseline=true, X_train=X_train, y_train=y_train, 
