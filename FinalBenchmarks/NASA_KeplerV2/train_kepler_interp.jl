...
using JLD2
dloc =  "/Users/joshua/Desktop/QuantumInspiredMLFinal/QuantumInspiredML/Data/NASA_kepler/c0/sample831v4.jld2"
f = jldopen(dloc, "r")
...
interp_sites = collect(61:92)
stats, p1_ns = any_impute_single_timeseries(fc, 0, 6, interp_sites, :directMedian; 
        invert_transform=true, 
           NN_baseline=false, X_train=X_train, y_train=y_train, 
