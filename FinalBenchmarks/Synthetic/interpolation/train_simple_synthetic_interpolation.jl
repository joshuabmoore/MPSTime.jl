...
dloc =  "Data/simple-synthetic/datasets/noisy_trendy_sine_eta_015_m_3_tau_20.jld2"
f = jldopen(dloc, "r")
...
svpath = "Data/simple-synthetic/mps-saves/new_legendre_ns_d$(d)_chi$(chi_max).jld2"
f = jldopen(svpath, "w")
